    ...
    import 'todo_item.dart'; // Import the TodoItem class
    ...
    class DatabaseHelper {
      ...
      void _onCreate(Database db, int version) async {
        ...
        await db.execute(
            "CREATE TABLE Journal(id TEXT PRIMARY KEY, date TEXT, heading TEXT, content TEXT)"); // Corrected line
        // Create the Todo table
        await db.execute(
            "CREATE TABLE Todo(id TEXT PRIMARY KEY, task TEXT, isCompleted INTEGER, createdAt TEXT)");
      }
